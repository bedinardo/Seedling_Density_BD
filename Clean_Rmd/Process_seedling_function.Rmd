...
for(i in years){
  file_saved<- file.path("C:/Users/Bryce/OneDrive - University Of Oregon/Data_Sci/Seedling_Density_BD/data/Seedling_TPA_sf/Douglas_Fir_TPA_sf", paste0("douglas-fir",i,".gpkg"))
...
for(i in years){
  file_saved<- file.path("C:/Users/Bryce/OneDrive - University Of Oregon/Data_Sci/Seedling_Density_BD/data/Seedling_TPA_sf/Western_Hemlock_TPA_SF", paste0("Western_hemlock",i,".gpkg"))
  process_seedlings(year = i, spcd = spcd, save_path = file_saved)
}
```
...
#Loop with in file path
for(i in years){
  file_saved<- file.path("C:/Users/Bryce/OneDrive - University Of Oregon/Data_Sci/Seedling_Density_BD/data/Seedling_TPA_sf/Lodge_Pole_TPA_SF", paste0("Lodge_Pole",i,".gpkg"))
  process_seedlings(year = i, spcd = spcd, save_path = file_saved)
}
```
