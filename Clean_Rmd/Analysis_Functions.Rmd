...
I have saved .gpkg files for all year and species combation that contain the climate variable values for each plot location. In order to run these function into ranger (the random forest function I'm using) I need to convert these files to a data frame and make sure catigorical data (landowner) varaibles are recorded as factors. This function only need the year and species of intrest
